...
module.exports = (eleventyConfig) => {
    ...
    const register = (theme) => {
        ...
        try {
            ...
            console.error(`Error: ${theme} Eleventy config not found! Skipped. ${err}`);
        }
    }
    ...
    try {
        ...
        // Fall gracefully
        console.error(`Error: site configuration not found, loading basic theme.: ${err}`);
    }

    themes[0] ? themes.forEach(theme => register(theme)) : console.log('Error: No theme selected')
}